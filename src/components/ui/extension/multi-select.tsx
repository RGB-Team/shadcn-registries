  ...
  return (
    ...
    >
      <Command
        ...
        className={cn("bg-transparent flex flex-col space-y-2", className)}
        dir={dir}
        {...props}
      >
        {children}
...
>(({ className, children, disableRender = false, ...props }, ref) => {
...
const MultiSelectorItem = forwardRef<
  ...
  { value: string; callback?: () => void } & React.ComponentPropsWithoutRef<
    typeof CommandPrimitive.Item
  >
>(({ className, value, children, callback, ...props }, ref) => {
